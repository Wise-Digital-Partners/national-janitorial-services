  ...
  return (
    <>
      {reviews.map((review, i) => {
        return (
          <div
            className="mb-6 w-full break-inside-avoid rounded-lg border border-gray-200 bg-white px-6 py-8 md:mb-10 md:p-8"
            key={i}
          >
            <div className="mb-4 flex items-center justify-between">
              ...
              {review.platform === "Google" && (
                <GatsbyImage image={data.google.childImageSharp.gatsbyImageData} loading="lazy" />
              )}
              {review.platform === "Yelp" && (
                <GatsbyImage image={data.yelp.childImageSharp.gatsbyImageData} loading="lazy" />
              )}
              {review.platform === "Facebook" && (
                <GatsbyImage image={data.facebook.childImageSharp.gatsbyImageData} loading="lazy" />
              )}
            </div>
            <blockquote>
