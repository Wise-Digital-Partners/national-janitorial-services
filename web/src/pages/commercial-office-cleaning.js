         ...
         <section className="py-16 md:py-32">
            <div className="container">
               <div className="grid grid-cols-1 md:grid-cols-2 gap-y-12 md:gap-x-10 lg:gap-x-20 items-center">
                  ...
                  <div>
                     <GatsbyImage image={data.intro} alt="Top Commercial Office Cleaning in Long Beach" />
                  </div>
               </div>
            </div>
         </section>
...
export const query = graphql`
   {
      openGraphImage: file(relativePath: { eq: "open-graph/facebook/Private Offices_FB.jpg" }) {
         publicURL
      }
      twitterOpenGraphImage: file(relativePath: { eq: "open-graph/twitter/Private Offices_TW.jpg" }) {
         publicURL
      }
