         ...
         <section className="pt-16 md:pt-32 mb-16 md:mb-32">
            <div className="container">
               <div className="grid grid-cols-1 md:grid-cols-2 md:gap-x-10 lg:gap-x-20 gap-y-12 items-center">
                  <div>
                     <h2>Keeping Long Beach Businesses Clean
</h2>
                     <p className="mb-0">
Do more than get a protective barrier on your company’s floor – optimize its appearance while protecting its lifespan with help from our professional floor waxing services. Our team only uses quality EPA-registered cleaning agents so that we can keep your space safe and sanitized. Contact us when you’re ready for floor waxing that locks in shine!
                     </p>
