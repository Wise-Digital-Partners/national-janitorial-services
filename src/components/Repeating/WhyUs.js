      ...
      <section className={`${className || ""}`}>
         <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-x-16 lg:gap-x-24 gap-y-10 md:gap-y-16 text-center md:text-left">
               <div>
                  <img src={data.icon1.publicURL} alt="Experienced" className="mx-auto md:mx-0 mb-3 md:mb-4" />
               ...
               <div>
                  <img src={data.icon2.publicURL} alt="Reliable & Local" className="mx-auto md:mx-0 mb-3 md:mb-4" />
               ...
               <div>
                  <img src={data.icon3.publicURL} alt="Good Value" className="mx-auto md:mx-0 mb-3 md:mb-4" />
               ...
               <div>
                  <img src={data.icon4.publicURL} alt="Professional" className="mx-auto md:mx-0 mb-3 md:mb-4" />
