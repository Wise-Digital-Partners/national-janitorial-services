...
const Page = ({ data }) => {
   ...
   return (
      <Layout navigationStyle="overlap" headerLinkColor="" headerHasBorder={false}>
         ...
         >
            <p className="text-mobile-7xl md:text-7xl font-display font-black text-accent uppercase mb-6 md:mb-2">Long Beach Janitorial Services</p>
         ...
         <CallToAction headingLevel="h2" heading="Comprehensive Janitorial Services for Long Beach Businesses" />

         <section className="py-16 md:py-32">
            <div className="container">
               <div className="grid grid-cols-1 md:grid-cols-2 md:gap-x-10 lg:gap-x-20 gap-y-10 items-center">
                  <div>
                     <h2>Why We Love Long Beach</h2>
                     <p className="mb-0">
                  ...
                  <div>
                     <GatsbyImage image={data.whyWeLove.childImageSharp.gatsbyImageData} alt="Why We Love Long Beach" />
                  </div>
               </div>
            </div>
         </section>
...
export const query = graphql`
   {
      ...
      whyWeLove: file(relativePath: { eq: "cities/Long Beach.jpg" }) {
         childImageSharp {
            gatsbyImageData(layout: FULL_WIDTH, placeholder: BLURRED, quality: 100)
         }
      }
