...
const Page = ({ data }) => {
   ...
   return (
      <Layout headerStyle="overlap" headerLinkColor="" headerHasBorder={false}>
         ...
         >
            <p className="text-mobile-7xl md:text-7xl font-display font-black text-accent uppercase mb-6 md:mb-2">San Diego Janitorial Services</p>
               ...
               <div className="grid grid-cols-1 md:grid-cols-12 md:gap-x-10 lg:gap-x-20 gap-y-10 items-center">
                  <div className="md:col-start-1 md:col-span-5 order-2 md:order-1">
                     <GatsbyImage
                        ...
                        alt="A Top Commercial Janitorial Services Company in San Diego"
         ...
         <section className="py-16 md:py-32">
            <div className="container">
               <div className="grid grid-cols-1 md:grid-cols-2 md:gap-x-10 lg:gap-x-20 gap-y-10 items-center">
                  ...
                  <div>
                     <GatsbyImage image={data.whyWeLove.childImageSharp.gatsbyImageData} alt="Why We Love San Diego" />
                  </div>
               </div>
            </div>
         </section>
...
export const query = graphql`
   {
      ...
      whyWeLove: file(relativePath: { eq: "cities/San Diego.jpg" }) {
         childImageSharp {
            gatsbyImageData(layout: FULL_WIDTH, placeholder: BLURRED, quality: 100)
         }
      }
