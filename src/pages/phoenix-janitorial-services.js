...
const Page = ({ data }) => {
   ...
   return (
      <Layout navigationStyle="overlap" headerLinkColor="" headerHasBorder={false}>
               ...
               <div className="grid grid-cols-1 md:grid-cols-12 md:gap-x-10 lg:gap-x-20 gap-y-10 items-center">
                  <div className="md:col-start-1 md:col-span-5 order-2 md:order-1">
                     <GatsbyImage
                        ...
                        alt="A Top Commercial Janitorial Services Company in Phoenix"
         ...
         <CallToAction headingLevel="h2" heading="Comprehensive Janitorial Services for Phoenix Businesses" />

         <section className="py-16 md:py-32">
            <div className="container">
               <div className="grid grid-cols-1 md:grid-cols-2 md:gap-x-10 lg:gap-x-20 gap-y-10 items-center">
                  <div>
                     <h2>Why We Love Phoenix</h2>
                     <p className="mb-0">
                  ...
                  <div>
                     <GatsbyImage image={data.whyWeLove.childImageSharp.gatsbyImageData} alt="Why We Love Phoenix" />
                  </div>
               </div>
            </div>
         </section>
...
export const query = graphql`
   {
      ...
      whyWeLove: file(relativePath: { eq: "cities/Phoenix.jpg" }) {
         childImageSharp {
            gatsbyImageData(layout: FULL_WIDTH, placeholder: BLURRED, quality: 100)
         }
      }
