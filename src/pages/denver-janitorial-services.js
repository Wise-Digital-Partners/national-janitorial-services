...
const Page = ({ data }) => {
   ...
   return (
      <Layout navigationStyle="overlap" headerLinkColor="" headerHasBorder={false}>
         ...
         >
            <p className="text-mobile-7xl md:text-7xl font-display font-black text-accent uppercase mb-6 md:mb-2">Denver Janitorial Services</p>
               ...
               <div className="grid grid-cols-1 md:grid-cols-12 md:gap-x-10 lg:gap-x-20 gap-y-10 items-center">
                  <div className="md:col-start-1 md:col-span-5 order-2 md:order-1">
                     <GatsbyImage
                        ...
                        alt="A Top Commercial Janitorial Services Company in Denver"
         ...
         <CallToAction headingLevel="h2" heading="Comprehensive Janitorial Services for Denver Businesses" />
