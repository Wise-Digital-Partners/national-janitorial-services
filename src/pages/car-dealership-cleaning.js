...
export const query = graphql`
   {
      openGraphImage: file(relativePath: { eq: "open-graph/facebook/Car Dealerships_FB.jpg" }) {
         publicURL
      }
      twitterOpenGraphImage: file(relativePath: { eq: "open-graph/twitter/Car Dealerships_TW.jpg" }) {
         publicURL
      }
