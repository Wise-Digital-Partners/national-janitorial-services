            ...
            <div className="container">
               ...
               <div className="grid grid-cols-1 md:grid-cols-12 md:gap-x-12 lg:gap-x-20 gap-y-10">
                  <div className="md:col-start-1 md:col-span-5">
                     <p className="mb-0">
                        In order to maintain our competitive pricing, and to accommodate our client’s standard accounting policies, National
                        Janitorial Services offers two billing choices.
                     </p>
                  </div>
