...
1. Go to your [project’s API settings on manage.sanity.io](https://www.sanity.io/manage/personal/project/0nqyibkq/settings) and create a token with read rights.
